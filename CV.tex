...
\begin{Detail}
\Item
Final winner is to be announced on 13 Sep 2018.
\end{Detail}}
...
\begin{Detail}
\Item
Scholarship for Samsung Convergence Software Course (SCSC) program.
\end{Detail}
...
\begin{Detail}
\Item
Merit-based. For attaining semester GPA of 4.15/4.3.
\end{Detail}
